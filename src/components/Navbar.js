...
const Navbar = () => {
    ...
    return (
        <div className={navbg ? "nav active" : "nav"}>
            <div className="burger text-light">
                <FaBars/>
            </div>
            <div className="logo">
                <Link className={logo?"item-link active": "item-link"} to="/"><h3 >Grab Eat</h3></Link>
            </div>
            <ul className="nav-links ">
                <li><Link className="item-link bg-light fw-bold rounded px-2 py-1 text-secondary" to="/signup">SIGNUP</Link></li>
